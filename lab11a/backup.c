...
void zerar(Caracteristicas time[]){
    ...
    for(i = 0; i < QUANTIDADEdeTIMES; i++){
        ...
        if(i < 4){
            strcpy(time[i].grupo, "A");
        }else if(i < 8){
            strcpy(time[i].grupo, "B");
        }else if(i < 12){
            strcpy(time[i].grupo, "C");
        }else if(i < 16){
            strcpy(time[i].grupo, "D");
        }else if(i < 20){
            strcpy(time[i].grupo, "E");
        }else if(i < 24){
            strcpy(time[i].grupo, "F");
        }else if(i < 28){
            strcpy(time[i].grupo, "G");
        }else if(i < 32){
            strcpy(time[i].grupo, "H");
        }
